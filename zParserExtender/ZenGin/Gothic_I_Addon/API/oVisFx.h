...
namespace Gothic_I_Addon {
  ...
  public:
    ...
    static void operator delete( void*, char const*, char const*, int )                                  zCall( 0x00476FB0 );
    ...
    static void* operator new( unsigned int, char const*, char const*, int )                             zCall( 0x0077F5E0 );

...
namespace Gothic_I_Addon {
  ...
  public:
    ...
    static void operator delete( void*, char const*, char const*, int )      zCall( 0x00478250 );
    static void* operator new( unsigned int, char const*, char const*, int ) zCall( 0x00479020 );

...
namespace Gothic_I_Addon {
  ...
  public:
    ...
    static void operator delete( void*, char const*, char const*, int )                                zCall( 0x00745970 );
  ...
  public:
    ...
    static void operator delete( void*, char const*, char const*, int ) zCall( 0x00745C70 );

...
namespace Gothic_I_Classic {
  ...
  public:
    ...
    static void operator delete( void*, char const*, char const*, int )   zCall( 0x00485620 );
  ...
  public:
    ...
    static void operator delete( void*, char const*, char const*, int )                             zCall( 0x0046E360 );

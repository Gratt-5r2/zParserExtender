...
namespace Gothic_I_Classic {
  ...
  public:
    ...
    static void operator delete( void*, char const*, char const*, int ) zCall( 0x005B7F50 );
  ...
  public:
    ...
    static void operator delete( void*, char const*, char const*, int )     zCall( 0x005B8310 );

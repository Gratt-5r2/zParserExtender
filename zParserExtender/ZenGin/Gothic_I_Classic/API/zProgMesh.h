...
namespace Gothic_I_Classic {
  ...
  public:
    ...
    static void operator delete( void*, char const*, char const*, int )                                                                        zCall( 0x00575880 );
...
#pragma pack( pop )
    ...
    static void operator delete( void*, char const*, char const*, int )                                       zCall( 0x00573290 );
